...
class TemplateController extends GetxController {
  ...
  final localTemplates = [
    MenuTemplate(
      ...
      previewImage: "assets/images/menu_preview_image_1.webp",
      jsonPath: "assets/json/editor_data_1.json",
      category: "Restaurant",
    ),
    MenuTemplate(
      title: "Neon Pink",
      previewImage: "assets/images/menu_preview_image_2.webp",
      jsonPath: "assets/json/editor_data_2.json",
      category: "Restaurant",
    ),
    MenuTemplate(
      title: "Neon Pink",
      previewImage: "assets/images/menu_preview_image_3.webp",
      jsonPath: "assets/json/editor_data_3.json",
      category: "Restaurant",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_4.webp",
    ...
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_6.webp",
      jsonPath: "assets/json/editor_data_6.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_7.webp",
      jsonPath: "assets/json/editor_data_7.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_8.webp",
      jsonPath: "assets/json/editor_data_8.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_9.webp",
      jsonPath: "assets/json/editor_data_9.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_10.webp",
      jsonPath: "assets/json/editor_data_10.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_11.webp",
      jsonPath: "assets/json/editor_data_11.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_12.webp",
      jsonPath: "assets/json/editor_data_12.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_13.webp",
      jsonPath: "assets/json/editor_data_13.json",
      category: "Wedding",
    ),
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_14.webp",
    ...
    MenuTemplate(
      title: "Floral Menu",
      previewImage: "assets/images/menu_preview_image_2.webp",
      jsonPath: "assets/json/editor_data_16.json",
      category: "Wedding",
    ),
  ];
  void loadTemplates() {
